...
- 제 2조, 코드공개의 강제성, 이 프로그램을 사용 중인 서버는 프로그램의 사용유무를 반드시 유저가 알 수 있게 해야하며, 프로그램의 코드를 다른 유저가 받을 수 있도록 해야한다.( 단 해당 프로그램을 판매중이지 않고, 개인소장용 일때는 해당 라이센스는 인정이 안된다 )
...
- 제 8조, 이 라이센스를 사용하게된 창작물, 수정본, 재배포물 등은 해당 라이센스를 사용중인 것을 반드시 표기해야함.( 미표기시 라이센스 위반 )
---------------------------
### 상업적 사용의 범주
